...
// Country data with dial codes and flags (alphabetically sorted, Palestine first)
const COUNTRIES = [
...
export interface PhoneFieldProps {
  /** Phone number value (without dial code) */
  value?: string;
...
/**
 * PhoneField - Standardized phone input component with country selector
 *
 * Features:
 * - Country code selector with flags
 * - Vertical divider between country and phone input
 * - Unified rounded border styling
  ...
  (
    ...
    return (
      <div className="flex flex-col gap-1.5 w-full">
        ...
        {/* Wrapper for positioning dropdown outside overflow */}
        <div className="relative" ref={dropdownRef}>
          <div
            className={cn(
              "flex items-center h-12 rounded-xl border bg-white transition-all duration-200",
