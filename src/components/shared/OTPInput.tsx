        ...
        >
          {Array.from({ length }).map((_, index) => (
            <motion.input
              ...
              className={cn(
                "w-12 h-14 text-center text-xl font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed",
                error
